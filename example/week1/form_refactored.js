document.querySelectorAll('footer input[type=radio]').forEach(enhanceRadioInputs)

function enhanceRadioInputs (input, i) {
  embedInDiv(input, enhanceConnectedLabel(input, i))
}

function enhanceConnectedLabel (input, i) {
